...
var DateUtil = function(){
     ...
     * 取得当前日期所在月的最小天数即1号
     */
    this.minDayOfDate = function(date)
    {
        date = arguments[0] || new Date();
        date.setDate(1);
        return date;
     ...
     * 取得当前日期所在周的最大天数 即周6
     */
    this.maxWeekDayOfDate = function(date)
    {
        date = arguments[0] || new Date();
        var weekDay = date.getDay();
        var time = date.getTime() + (6-weekDay)* 24 * 60 * 60 * 1000;
        var newDate = new Date(time);
        return newDate;
    }
     ...
     * 取得当前日期所在周的最小天数即周日
     */
    this.minWeekDayOfDate = function(date)
    {
        date = arguments[0] || new Date();
        var weekDay = date.getDay();
        var time = date.getTime() - weekDay* 24 * 60 * 60 * 1000;
        var newDate = new Date(time);
        return newDate;
    }
    /**
     * 取得当前日期所在年的第几周
     */
    this.WeekNumberOfYear = function(date)
    {
     ...
     * 取得当前日期所在年的第几个季度
     */
    this.QuarterOfYear = function(date)
    {
